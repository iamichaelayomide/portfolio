      ...
      <div className="section-shell relative z-raised grid w-full items-center gap-10 py-16 sm:py-24 lg:grid-cols-[minmax(0,1.05fr)_420px] lg:gap-14">
        ...
        >
          ...
          <motion.h1
            ...
            className="max-w-[12ch] text-balance font-display text-display-xl text-text-primary sm:max-w-[13ch] lg:text-display-2xl"
          >
            {content.title}
          </motion.h1>
          ...
          <motion.p
            ...
            className="mt-5 max-w-[34rem] text-pretty font-body text-body-md text-text-secondary sm:mt-6 sm:text-body-lg"
          >
            {content.description}
          </motion.p>
