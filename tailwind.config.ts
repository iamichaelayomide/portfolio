...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        "display-xl": ["clamp(44px, 5.5vw, 64px)", { lineHeight: "1.08", letterSpacing: "-0.03em" }],
        "display-lg": ["clamp(32px, 4vw, 48px)", { lineHeight: "1.08", letterSpacing: "-0.03em" }],
        "display-md": ["clamp(26px, 3vw, 36px)", { lineHeight: "1.12", letterSpacing: "-0.025em" }],
        "display-sm": ["clamp(20px, 2.5vw, 28px)", { lineHeight: "1.18", letterSpacing: "-0.02em" }],
        "body-lg": ["18px", "1.7"],
        "body-md": ["16px", "1.65"],
        "body-sm": ["14px", "1.6"],
        "body-xs": ["12px", "1.5"],
