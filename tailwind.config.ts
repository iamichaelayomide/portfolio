...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        "display-xl": ["clamp(52px, 6vw, 80px)", { lineHeight: "1.08", letterSpacing: "-0.03em" }],
        "display-lg": ["clamp(36px, 4.5vw, 60px)", { lineHeight: "1.08", letterSpacing: "-0.03em" }],
        "display-md": ["clamp(28px, 3vw, 44px)", { lineHeight: "1.12", letterSpacing: "-0.025em" }],
        "display-sm": ["clamp(22px, 2.5vw, 32px)", { lineHeight: "1.18", letterSpacing: "-0.02em" }],
        "body-lg": ["18px", "1.7"],
        "body-md": ["16px", "1.65"],
        "body-sm": ["14px", "1.6"],
        "body-xs": ["12px", "1.5"],
